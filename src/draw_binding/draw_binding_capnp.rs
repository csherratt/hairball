...
// DO NOT EDIT.
// source: draw_binding.capnp


pub mod draw_binding {
  ...
  impl <'a,> Builder<'a,>
   {
    ...
    #[inline]
    pub fn set_geometry(&mut self, value : u32)  {
    ...
    #[inline]
    pub fn set_material(&mut self, value : u32)  {
  ...
  mod _private {
    ...
    pub const TYPE_ID: u64 = 0x834cb888e054deeb;
  }
}
...
pub mod column {
  ...
  impl <'a,> Reader<'a,>
  {
    ...
    #[inline]
    pub fn get_bindings(self) -> Result<struct_list::Reader<'a,::draw_binding_capnp::draw_binding::Owned<>>> {
  ...
  impl <'a,> Builder<'a,>
   {
    ...
    #[inline]
    pub fn get_bindings(self) -> Result<struct_list::Builder<'a,::draw_binding_capnp::draw_binding::Owned<>>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(0))
    }
    #[inline]
    pub fn set_bindings(&mut self, value : struct_list::Reader<'a,::draw_binding_capnp::draw_binding::Owned<>>) -> Result<()> {
      ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.get_pointer_field(0), value)
    }
    #[inline]
    pub fn init_bindings(self, size : u32) -> struct_list::Builder<'a,::draw_binding_capnp::draw_binding::Owned<>> {
  ...
  mod _private {
    ...
    pub const TYPE_ID: u64 = 0xf1df6bea087fbbc1;
  }
}
