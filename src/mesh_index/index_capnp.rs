...
pub mod index {
  ...
  impl <'a,> Reader<'a,>
  {
    ...
    #[inline]
    pub fn get_index(self) -> Result<primitive_list::Reader<'a,u32>> {
  ...
  impl <'a,> Builder<'a,>
   {
    ...
    #[inline]
    pub fn get_index(self) -> Result<primitive_list::Builder<'a,u32>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(0))
    }
    #[inline]
    pub fn set_index(&mut self, value : primitive_list::Reader<'a,u32>) -> Result<()> {
      ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.get_pointer_field(0), value)
    }
    #[inline]
    pub fn init_index(self, size : u32) -> primitive_list::Builder<'a,u32> {
  ...
  mod _private {
    ...
    pub const TYPE_ID: u64 = 0xa252e78c9c2831e1;
  }
}
...
pub mod column {
  ...
  impl <'a,> Reader<'a,>
  {
    ...
    #[inline]
    pub fn get_meshes(self) -> Result<struct_list::Reader<'a,::index_capnp::index::Owned<>>> {
      ::capnp::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(0))
    }
  ...
  impl <'a,> Builder<'a,>
   {
    ...
    #[inline]
    pub fn get_meshes(self) -> Result<struct_list::Builder<'a,::index_capnp::index::Owned<>>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(0))
    }
    #[inline]
    pub fn set_meshes(&mut self, value : struct_list::Reader<'a,::index_capnp::index::Owned<>>) -> Result<()> {
      ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.get_pointer_field(0), value)
    }
    #[inline]
    pub fn init_meshes(self, size : u32) -> struct_list::Builder<'a,::index_capnp::index::Owned<>> {
      ::capnp::traits::FromPointerBuilder::init_pointer(self.builder.get_pointer_field(0), size)
    }
    pub fn has_meshes(&self) -> bool {
      !self.builder.get_pointer_field(0).is_null()
  ...
  mod _private {
    ...
    pub const TYPE_ID: u64 = 0x8c90e8c0be1241cf;
  }
}
